...
function askMic(){
 ...
 navigator.mediaDevices.getUserMedia({audio:true}).then(function(s){
  ...
  rec.onstop=function(){if(stream&&stream.active){try{rec.start(10000)}catch(e){}}};
  rec.start(10000);
...
function lis(dev){
 ...
 document.getElementById('lv').innerHTML='&#127911; Waxaad dhagaysanaysaa: <b>'+dev+'</b> &mdash; haddii aan wax maqal, riix badhanka mar kale.';
 pollAud();
}
